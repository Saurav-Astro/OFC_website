  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b-2 border-primary/20 bg-black/95 backdrop-blur-md supports-[backdrop-filter]:bg-black/80 cage-pattern-subtle">
      <div className="container flex h-16 items-center justify-between">
        <Link href="/" className="flex items-center gap-2 group" aria-label="OctaFight Home">
          <OfcLogo className="h-9 w-auto text-primary transition-all duration-300 group-hover:drop-shadow-[0_0_10px_hsl(var(--primary)/0.8)]" />
          <span className="font-headline text-2xl font-black hidden sm:inline-block text-primary group-hover:text-secondary transition-colors">
            OctaFight
          </span>
        </Link>
