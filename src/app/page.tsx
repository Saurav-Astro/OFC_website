  ...
  return (
    <div className="flex flex-col">
      ...
      <ZoomParallax images={parallaxImages}>
        <div className="relative z-10 p-8 rounded-2xl bg-black/60 backdrop-blur-sm border border-white/10 shadow-2xl">
          <FloatingElement intensity={10}>
             <OfcLogo className="w-56 h-auto mb-6 text-primary mx-auto drop-shadow-lg" />
          </FloatingElement>
          
          <h1 className="font-headline text-5xl md:text-8xl font-black tracking-wider text-primary uppercase text-shadow-md mb-2 leading-none">
            Forged in Combat
          </h1>
          
          <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 mb-4">
             <p className="text-2xl md:text-4xl font-body font-bold text-white uppercase tracking-widest drop-shadow-md">
               Proven in Blood.
             </p>
             <p className="text-2xl md:text-4xl font-headline text-secondary uppercase tracking-widest drop-shadow-md">
               Crowned in Glory.
             </p>
          </div>
          ...
          <div className="mt-8 flex justify-center gap-4">
            <Button size="lg" className="font-headline text-lg tracking-wide hover:scale-105 transition-transform">
               Latest Events
            </Button>
            <Button variant="outline" size="lg" className="font-headline text-lg tracking-wide hover:bg-white/10 hover:scale-105 transition-transform">
               Fighter Roster
            </Button>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <ScrollReveal direction="left" delay={0.2}>
                <div className="text-center md:text-left">
                  <h2 className="font-headline text-3xl md:text-5xl font-black uppercase tracking-wider text-primary combat-shadow">The OFC Legacy</h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <ScrollReveal direction="left" delay={0.3}>
                <div className="text-center md:text-left">
                  ...
                  <Button asChild size="lg" className="aggressive-glow font-bold text-lg px-8 strike-animation">
                    <Link href="/events">
