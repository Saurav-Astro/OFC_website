...
import { ScrollReveal, StaggerContainer, StaggerItem, ScrollProgressBar } from '@/components/scroll-animations';
      ...
      <CardHeader className="p-0">
        <div className="relative aspect-[3/4] w-full">
          ...
          <div className="absolute bottom-0 left-0 p-3">
            <h3 className="font-headline text-xl lg:text-3xl font-black text-white uppercase tracking-wider italic combat-shadow">{event.name}</h3>
          </div>
        </div>
      </CardHeader>
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative w-full h-[93vh] overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 cage-pattern-subtle opacity-20" />
        <div className="relative h-full flex flex-col items-center justify-center text-center px-4 z-10">
          <FadeIn>
            <h1 className="font-headline text-5xl md:text-7xl font-black uppercase tracking-wider text-primary combat-shadow-strong mb-4">Fight Nights</h1>
            <p className="mt-4 max-w-2xl mx-auto text-lg md:text-xl text-white/90 font-semibold">
              Witness the glory. Experience the violence. Remember the legends.
            </p>
